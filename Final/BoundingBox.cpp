...
BoundingBox::BoundingBox(OBJObject *obj)
{
    ...
    this->min.x = this->object2->vertices[0].x;
    this->max.x = this->object2->vertices[0].x;
    this->min.y = this->object2->vertices[0].y;
    this->max.y = this->object2->vertices[0].y;
    this->min.z = this->object2->vertices[0].z;
    this->max.z = this->object2->vertices[0].z;
    
    for (int i = 0; i < this->object2->vertices.size(); i++) {
        if (this->object2->vertices[i].x < this->min.x)
            this->min.x = this->object2->vertices[i].x;
        if (this->object2->vertices[i].x > this->max.x)
            this->max.x = this->object2->vertices[i].x;
        
        if (this->object2->vertices[i].y < this->min.y)
            this->min.y = this->object2->vertices[i].y;
        if (this->object2->vertices[i].y > this->max.y)
            this->max.y = this->object2->vertices[i].y;
        
        if (this->object2->vertices[i].z < this->min.z)
            this->min.z = this->object2->vertices[i].z;
        if (this->object2->vertices[i].z > this->max.z)
            this->max.z = this->object2->vertices[i].z;
    }
...
void BoundingBox::draw2(GLuint shaderProgram)
{
    this->toWorld = this->object2->toWorld* transform;
...
void BoundingBox::update2()
{
    glm::vec3 temp = glm::vec3(this->object2->toWorld * glm::vec4(this->object2->vertices[0], 1.0f));
    this->min.x = temp.x;
    this->max.x = temp.x;
    this->min.y = temp.y;
    this->max.y = temp.y;
    ...
    for (int i = 0; i < this->object2->vertices.size(); i++) {
        temp = glm::vec3(this->object2->toWorld * glm::vec4(this->object2->vertices[i], 1.0f));
        if (temp.x < this->min.x)
            this->min.x = temp.x;
        if (temp.x > this->max.x)
            this->max.x = temp.x;
